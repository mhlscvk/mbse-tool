# Faz 1/2 Brief v1.5 — Canonical Operational Notes

**Versiyon:** v1.5 (Faz 2 Slice 3 = Bug-RENDER-01 3a+3b sonrası; Faz 1 state-machine zinciri + ilk Faz 2 bug slice'ı tamam)
**Tarih:** 2026-05-26
**Author:** Architect Claude
**Önceki sürümler:** v1.0 (Faz 1 ilk brief), v1.1 (Slice 2c), v1.2 (Slice 2d.1 narrative), v1.3 (Slice 2d.1 canonical ops), v1.4 (Slice 2d.1+2d.3+2d.2)
**Çapraz referans:** `phase2_slice3a_handover.md`, `phase2_slice3b_handover.md`, `bug_render_01_slice3b_discovery.md`, `bug_render_01_slice3b_audit.md`, `phase1_slice2d2_handover.md`, `renderer_refactor_strategy_v2.md`, `docs/adr/005-state-machine-renderer.md`
...
pre-commit hook = api + diagram + web-client         = 340 + 674 + 132 = 1146
```
...
**Brief yazımı:** "1146 yeşil" derken pre-commit hook kastediliyor. "1014 yeşil" derken manuel `pnpm test`.

**web-client evrimi:** v1.4'te 128; Slice 3b RTL harness (`@testing-library/react` + mock-model factory) ile +4 (data-node-id test 2 + bug-render-01 repro 2) → **132**.

**Sayım değişirse:** Yeni test eklenince bu doc güncellenmeli (v1.6, v1.7...). **CLAUDE.md de güncellenmeli** — Slice 3b kapanışında (2026-05-26) CLAUDE.md 1142 → 1146 ve web-client 128 → 132 güncellendi; drift kapatıldı.
...
| v1.6 | (planlanan) | Slice 2e (WS auth + HierarchicalFlagProvider + JWT migration) sonrası |
| v1.7 | (planlanan) | Security B1+B3 + legacy view porto serisi sonrası |
